...
void ImageSystemBackendGST::addSink(short port, int extras)
{
    ...
    m_Processors[size].index = m_ImageSystem->addImageProcessor(extras, "GStreamer sink on UDP port " + std::to_string(port));
}